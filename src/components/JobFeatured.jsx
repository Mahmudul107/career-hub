  ...
  return (
    <div className="my-container w-5/6 h-96 mb-6 border">
      ...
      <div className="flex gap-7 mb-6 text-base">
        ...
        <Link to="/" className="inline-flex items-center h-10 px-3 font-medium text-white transition duration-300 rounded shadow-lg  md:mb-0 bg-purple-400 hover:bg-purple-600">
